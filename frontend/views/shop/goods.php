            ...
            <ul>
                <li>您好，欢迎来到京西！
                    ...
                    if(Yii::$app->user->isGuest){
                        echo ' [<a href="/member/login.html">登录</a>] </li>';
                    }else{
                        echo ' [<a href="/member/logout.html">'.'退出登录 (' . Yii::$app->user->identity->username.')'.'</a>] </li>';
                    }
                    ?>
                </li>
                <li>[<a href="/member/register.html">免费注册</a>] </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="">首页</a> >
            <a href="">电脑、办公</a> >
            <a href="">笔记本</a> >
            ThinkPad X230(23063T4）12.5英寸笔记本</h2>
    </div>
    <!-- 面包屑导航 end -->
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?="http://www.yii2shop.com".$goods->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?="http://www.yii2shop.com".$goods->logo?>">             <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                        ...
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}">
                                    <img src="<?="http://www.yii2shop.com".$goods->logo?>"></a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<?=$goods->view_times?>人浏览评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
