                ...
                <?php foreach ($goods as $good):?>
                    ...
                    <dt><a href="">'.$cate->name.'</a></dt>';
                                foreach($cate->cates as $rows){
                                    echo '<dd><a href="/shop/goods.html?id='.$rows->id.'">'.$rows->name.'</a></dd>';
                                }
                                echo '</dl>';
                            }?>
                        </div>
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                <?php foreach ($goods as $good):?>
                    <li>
                        <dl>
                            <dt><a href="/shop/goods.html?id=<?=$good->id?>"><img src="<?="http://www.yii2shop.com". $good->logo ?>"></a></dt>
                            <dd><a href="/shop/goods.html?id=<?=$good->id?>"><?=$good->name?></a></dt>
        ...
        <div class="page mt20">
            ...
            <span>
                ...
                ?>
					<em>共<?=ceil($page->totalCount/$page->defaultPageSize)?>页&nbsp;&nbsp;到第 <input type="text" class="page_num" value="3"/> 页</em>
